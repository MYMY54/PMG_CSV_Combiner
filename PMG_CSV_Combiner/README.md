# CSV Combiner
This is my solution of a command line program that takes several CSV files as arguments. 
The program will output a new CSV file to `stdout` that contains the

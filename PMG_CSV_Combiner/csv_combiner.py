...
class CsvCombiner:
    ...
    def validate_path(self, file_path):
        """
        This function checks whether a file is a valid csv file or not.
        If the file doesn't exist, or it's an empty file, or it is not a csv file, return an exception.
        """
    ...
    def csv_combiner(self, path_lists):
        ...
        """
        In order to deal with large files, set the iterator of read_csv() as true to read file by chunks
        """
        chunk_list = []
        for file in path_lists:
            read_chunk = pd.read_csv(file, iterator=True, chunksize=1000000)
